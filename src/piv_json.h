...
inline bool AcceptText(const T& input, bool ignore_comments, bool ignore_trailing_commas)
{
    return J::accept(input, ignore_comments, ignore_trailing_commas);
}
 ...
 */
template <typename J>
bool AcceptFile(const wchar_t* file, bool ignore_comments, bool ignore_trailing_commas)
{
    FILE* fp = nullptr;
    _wfopen_s(&fp, file, L"r");
    if (!fp)
        return false;
    bool ret = J::accept(fp, ignore_comments, ignore_trailing_commas);
    fclose(fp);
    return ret;
}
 ...
 */
template <typename J>
bool Accept(const ::piv::string_view& input, bool ignore_comments, bool ignore_trailing_commas)
{
    ...
    if (test.front() == '{' || test.front() == '[')
        return AcceptText<J>(test, ignore_comments, ignore_trailing_commas);
    else
        return AcceptFile<J>(PivU2W{test.data(), test.size()}.c_str(), ignore_comments, ignore_trailing_commas);
}

template <typename J>
bool Accept(const ::piv::wstring_view& input, bool ignore_comments, bool ignore_trailing_commas)
{
    ...
    if (test.front() == '{' || test.front() == '[')
        ...
        return AcceptFile<J>(std::wstring{test.data(), test.size()}.c_str(), ignore_comments, ignore_trailing_commas);
}

template <typename J>
inline bool Accept(const std::string& input, bool ignore_comments, bool ignore_trailing_commas)
{
    return Accept<J>(::piv::string_view{input}, ignore_comments, ignore_trailing_commas);
}

template <typename J>
bool Accept(const std::wstring& input, bool ignore_comments, bool ignore_trailing_commas)
{
    return Accept<J>(::piv::wstring_view{input}, ignore_comments, ignore_trailing_commas);
}

template <typename J>
inline bool Accept(const wchar_t* input, bool ignore_comments, bool ignore_trailing_commas)
{
    return Accept<J>(::piv::wstring_view{input}, ignore_comments, ignore_trailing_commas);
}

template <typename J>
bool Accept(const CWString& input, bool ignore_comments, bool ignore_trailing_commas)
{
    return Accept<J>(::piv::wstring_view{input.GetText()}, ignore_comments, ignore_trailing_commas);
}

template <typename J>
bool Accept(const CVolMem& input, bool ignore_comments, bool ignore_trailing_commas)
{
    const unsigned char* data = input.GetPtr();
    size_t len = static_cast<size_t>(input.GetSize());
    if (len == 0)
        return false;
    if (::piv::encoding::is_utf8(data, len)) // UTF-8
    {
        ...
        return Accept<J>(::piv::string_view{reinterpret_cast<const char*>(data), len}, ignore_comments, ignore_trailing_commas);
    }
    if (::piv::encoding::is_utf16(data, len)) // UTF-16LE
    {
        ...
        return Accept<J>(::piv::wstring_view{reinterpret_cast<const wchar_t*>(data), len / 2}, ignore_comments, ignore_trailing_commas);
    }
    else
    {
        return Accept<J>(PivA2U{reinterpret_cast<const char*>(input.GetPtr()), len}.str, ignore_comments, ignore_trailing_commas);
    }
}
...
inline bool ParseText(J&& json, const T& input, const F cb, bool allow_exceptions, bool ignore_comments, bool ignore_trailing_commas)
{
    json = std::decay<J>::type::parse(input, cb, allow_exceptions, ignore_comments, ignore_trailing_commas);
...
bool ParseFile(J&& json, const wchar_t* file, const F cb, bool allow_exceptions, bool ignore_comments, bool ignore_trailing_commas)
{
    FILE* fp = nullptr;
    _wfopen_s(&fp, file, L"r");
    if (!fp)
        return false;
    json = std::decay<J>::type::parse(fp, cb, allow_exceptions, ignore_comments, ignore_trailing_commas);
    fclose(fp);
    return !json.is_discarded();
}
 ...
 */
template <typename J, typename F>
bool Parse(J&& json, const ::piv::string_view& input, const F cb, bool allow_exceptions, bool ignore_comments, bool ignore_trailing_commas)
{
    ::piv::string_view test{input};
    ::piv::edit::trim_left(test);
    ::piv::edit::trim_right(test);
    if (test.empty())
        return false;
    if (test.front() == '{' || test.front() == '[')
        return ParseText(json, test, cb, allow_exceptions, ignore_comments, ignore_trailing_commas);
    else
        return ParseFile(json, PivU2W{test.data(), test.size()}.c_str(), cb, allow_exceptions, ignore_comments, ignore_trailing_commas);
}

template <typename J, typename F>
bool Parse(J&& json, const ::piv::wstring_view& input, const F cb, bool allow_exceptions, bool ignore_comments, bool ignore_trailing_commas)
{
    ::piv::wstring_view test{input};
    ::piv::edit::trim_left(test);
    ::piv::edit::trim_right(test);
    ...
    if (test.front() == '{' || test.front() == '[')
        ...
        return ParseFile(json, std::wstring{test.data(), test.size()}.c_str(), cb, allow_exceptions, ignore_comments, ignore_trailing_commas);
}

template <typename J, typename F>
inline bool Parse(J&& json, const std::string& input, const F cb, bool allow_exceptions, bool ignore_comments, bool ignore_trailing_commas)
{
    return Parse(json, ::piv::string_view{input}, cb, allow_exceptions, ignore_comments, ignore_trailing_commas);
}

template <typename J, typename F>
bool Parse(J&& json, const std::wstring& input, const F cb, bool allow_exceptions, bool ignore_comments, bool ignore_trailing_commas)
{
    return Parse(json, ::piv::wstring_view{input}, cb, allow_exceptions, ignore_comments, ignore_trailing_commas);
}

template <typename J, typename F>
bool Parse(J&& json, const CWString& input, const F cb, bool allow_exceptions, bool ignore_comments, bool ignore_trailing_commas)
{
    return Parse(json, ::piv::wstring_view{input.GetText()}, cb, allow_exceptions, ignore_comments, ignore_trailing_commas);
}

template <typename J, typename F>
inline bool Parse(J&& json, const wchar_t* input, const F cb, bool allow_exceptions, bool ignore_comments, bool ignore_trailing_commas)
{
    return Parse(json, ::piv::wstring_view{input}, cb, allow_exceptions, ignore_comments, ignore_trailing_commas);
}

template <typename J, typename F>
inline bool Parse(J&& json, const CVolMem& input, const F cb, bool allow_exceptions, bool ignore_comments, bool ignore_trailing_commas)
{
    const unsigned char* data = input.GetPtr();
    size_t len = static_cast<size_t>(input.GetSize());
    if (len == 0)
    ...
    if (::piv::encoding::is_utf8(data, len)) // UTF-8
    {
        ...
        return ParseText(json, ::piv::string_view{reinterpret_cast<const char*>(data), len}, cb, allow_exceptions, ignore_comments, ignore_trailing_commas);
    }
    if (::piv::encoding::is_utf16(data, len)) // UTF-16LE
    {
        if (data[0] == 0xFF && len > 2 && data[1] == 0xFE)
        ...
        if (reinterpret_cast<const wchar_t*>(data)[0] == '{' || reinterpret_cast<const wchar_t*>(data)[0] == '[')
            return ParseText(json, ::piv::wstring_view{reinterpret_cast<const wchar_t*>(data), len}, cb, allow_exceptions, ignore_comments, ignore_trailing_commas);
    }
    else
    {
        return ParseText(json, PivA2U{reinterpret_cast<const char*>(data), len}.str, cb, allow_exceptions, ignore_comments, ignore_trailing_commas);
    }
}
...
{
    return typename J::json_pointer{PivAny2Us<true>{path}.str};
}
...
{
    if (path[0] == '/')
        return EmplaceAtPath(json, typename std::decay<J>::type::json_pointer{PivW2U{path}.str}, to_value(val));
    else
...
{
    if (path[0] == '/')
        return EmplaceAtPath(json, typename std::decay<J>::type::json_pointer{path}, to_value(val));
    else
        return EmplaceAtKey(json, to_key(path), to_value(val), replace);
}
...
inline bool EmplaceAt(J&& json, const ::piv::string_view& path, V&& val, bool replace = false)
{
    if (path.empty())
        return false;
    if (path.front() == '/')
        return EmplaceAtPath(json, typename std::decay<J>::type::json_pointer{path.data()}, to_value(val));
    else
        return EmplaceAtKey(json, to_key(path), to_value(val), replace);
}
