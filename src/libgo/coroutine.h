#ifndef LIBGO_COROUTINE_H
#define LIBGO_COROUTINE_H
#define __const__
...
// #define co_cls(type, ...) LIBGO_CLS(type, ##__VA_ARGS__)
// #define co_cls_ref(type) LIBGO_CLS_REF(type)
