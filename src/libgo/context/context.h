#ifndef LIBGO_CONTEXT_CONTEXT_H
#define LIBGO_CONTEXT_CONTEXT_H
...
namespace co {
    ...
    public:
        ...
        {
            LIBGO_DebugPrint(dbg_task, "valloc stack. size=%lu", (unsigned long)stackSize);
