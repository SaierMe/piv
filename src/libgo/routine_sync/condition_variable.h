#ifndef LIBGO_ROUTINE_SYNC_CONDITION_VARIABLE_H
#define LIBGO_ROUTINE_SYNC_CONDITION_VARIABLE_H
#include "mutex.h"
...
public:
    ...
    int notify_one()
    {
        ...
        LIBGO_RS_DBG(dbg_cond_v, "cond=%ld rutex=%ld | %s | val=%d | return %d",
...
public:
            ...
            const std::chrono::time_point<_Clock, _Duration> * abstime)
    {
        ...
        LIBGO_RS_DBG(dbg_cond_v, "cond=%ld rutex=%ld | %s | expectedValue=%d | abstime=%d | begin wait_until",
        ...
        LIBGO_RS_DBG(dbg_cond_v, "cond=%ld rutex=%ld | %s | expectedValue=%d | wait_until return %s | status=%s",
...
#endif // LIBGO_ROUTINE_SYNC_CONDITION_VARIABLE_H
