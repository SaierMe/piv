#ifndef LIBGO_ROUTINE_SYNC_DEBUG_H
#define LIBGO_ROUTINE_SYNC_DEBUG_H
#include <atomic>
#include <mutex>
...
# if DEBUG_ROUTINE_SYNC_IN_LIBGO
    ...
    using co::dbg_mutex;
    using co::dbg_cond_v;
#  define LIBGO_RS_DBG LIBGO_DebugPrint
    ...
    do { \
        if (rsDebugMask() & (type)) { \
            ...
            fprintf(::libgo::rsDebugOutputFile(), "[%s][%05d][%04d][%06d]%s:%d:(%s)\t " fmt "\n", \
                    ...
                    ::libgo::rsGetPid(), ::libgo::rsGetTid(), ::libgo::rsGetCid()(), \
...
#endif // LIBGO_ROUTINE_SYNC_DEBUG_H
