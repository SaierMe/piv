#ifndef LIBGO_COMMON_ANYS_H
#define LIBGO_COMMON_ANYS_H
#include "config.h"
#include "spinlock.h"
#include <string>
#include <vector>
...
public:
    ...
    template <typename T>
    LIBGO_INLINE T& get(std::size_t index)
    {
...
public:
    ...
    // Copy from g++ std.
    inline void* align(int __align, int __size, void*& __ptr, size_t& __space) noexcept
    {
