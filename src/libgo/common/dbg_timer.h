#ifndef LIBGO_COMMON_DBG_TIMER_H
#define LIBGO_COMMON_DBG_TIMER_H
#include "config.h"
#include "clock.h"

namespace co {

#define LIBGO_DBG_TIMER_CHECK(t) do {\
...
#endif // LIBGO_COMMON_DBG_TIMER_H
